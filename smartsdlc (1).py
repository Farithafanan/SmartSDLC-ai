...
Original file is located at
    https://colab.research.google.com/drive/1kIHjvbYNnrD6wo_lWjWltCvQaqNPMMxw
"""
...
def requirement_analysis(pdf_file, prompt_text):
  ...
  if pdf_file is not None:
    ...
    analysis_prompt = f"Analyze the following document and extract key software requirements. organize them into functional  requirements, non-functional requirements: {content}"
  else:
    analysis_prompt = f"Analyze the following requirements and organize them into functional requirements, non-functional requirements, and technical specific requirements: {prompt_text}"
...
with gr.Blocks() as app:
  gr.Markdown("# Smart Code Analysis & Generation Tool")
  ...
  with gr.Tabs():
    ...
    with gr.TabItem("Code Generation"):
      with gr.Row():
        ...
        with gr.Column():
          code_output = gr.Textbox(label="Generate Code", lines=20)
